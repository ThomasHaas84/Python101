...
die_adjektive = ["müde", "wach", "schnell", "langsam", "feucht", "trocken", "stinkend", "müffelnd", "heiß", "kalt",
             ...
             "rot", "grün", "blau", "gelb", "lila", "rosa", "durchsichtig", "heiß", "kalt", "krank", "abstinent",
             ...
             "athletisch", "attraktiv", "scharmlos", "bedeutend", "beglückend", "bezaubernd", "charaktervoll", "dominant",
             ...
             "phantastisch", "persönlich", "pikant", "potent", "fruchtbar", "prächtig", "prall", "hochsensibel", "quicklebendig",
...
die_nomen = ["der_Bagger", "der_Elefant", "das_Einhorn", "die_Kuh", "die_Maus", "die_Feder", "der_Vogel", "das_Haus", "die_Fledermaus", "das_Handy", "die_Ratte",
         ...
         "die_Tastatur", "die_Maus", "der_Controller", "der_Monitor", "der_Drucker", "der_Esel", "die_Schnecke", "die Biene", "die Laus", "die Elster",
         ...
         "der Vulkan", "die Zimmerpflanze", "das Badesalz", "das Eisenatom", "das Goldplättchen", "der Wattebausch", "die Handtasche", "der Baum", "die Stulle", "die Stute", "Staubkorn",
         ...
         "der Schwanz", "die Röhre", "die Gießkanne", "das Staubkorn", ]
